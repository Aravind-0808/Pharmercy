    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr data-id="{{ $product->id }}">
                ...
                <td>
                    @if($product->image)
                        <img src="{{ asset('storage/' . $product->image) }}" class="img-thumbnail" style="width:60px;height:60px;">
                    @else
                ...
                <td>
                    <button class="btn btn-sm btn-info editProductBtn" data-toggle="modal" data-target="#editProductModal">Edit</button>
            ...
            <form id="addProductForm" method="POST" action="{{ route('seller.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="store_id" required>
                    </div>
                    <div class="form-group">
                        <label>Name</label>
        ...
        <div class="modal-content">
            <form id="editProductForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Original Price</label>
                        <input type="number" step="0.01" class="form-control" name="original_price" id="editProductOriginalPrice" required>
                    </div>
                    <div class="form-group">
                        <label>Discount Percentage</label>
                        <input type="number" step="0.01" class="form-control" name="discount" id="editProductDiscount" required>
                    </div>
                    <div class="form-group">
                        <label>Stock</label>
