               ...
               @if (count($doctors) > 0)
                @foreach($doctors as $doctor)
                    <tr data-id="{{ $doctor->id }}">
                        ...
                        <td>
                            @if($doctor->logo)
                                <img src="{{ asset("/storage/{$doctor->logo}") }}" class="img-thumbnail" style="width:40px;height:40px;">
                            @else
    ...
    <div class="modal fade" id="addDoctorModal" tabindex="-1" role="dialog" aria-labelledby="addDoctorModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="addDoctorForm" method="POST" action="{{ route('seller.doctors.store') }}" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="modal-content">
                ...
                <form id="editDoctorForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Specialization</label>
                            <input type="text" class="form-control" name="specialization" id="editDoctorSpecialization" required>
                        </div>
                        <div class="form-group">
                            <label>Phone</label>
