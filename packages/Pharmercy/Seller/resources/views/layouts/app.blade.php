    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <span class="brand-text font-weight-bold">SELLER</span> <!-- Updated brand name -->
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        <!-- Dashboard -->
                        <li class="nav-item">
                            <a href="{{ route('seller.dashboard') }}" class="nav-link active"> <!-- Updated route -->
                        ...
                        <!-- Store Management -->
                        <li class="nav-item">
                            <a href="{{ route('seller.product.table') }}" class="nav-link">
                        ...
                        <!-- Wallet Management -->
                        <li class="nav-item">
                            <a href="{{ route('seller.wallet.table') }}" class="nav-link">
                        ...
                        <!-- Order Management -->
                        <li class="nav-item">
                            <a href="{{ route('seller.order.table') }}" class="nav-link">
                        ...
                        <!-- Withdrawal Requests -->
                        <li class="nav-item">
                            <a href="{{ route('seller.withdrawal.request') }}" class="nav-link">
